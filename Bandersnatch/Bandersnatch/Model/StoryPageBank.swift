...
class StoryPageBank {
    ...
    init() {
       ...
       pageList.append(StoryPages(text: "He nods slowly, unphased by the question", answerOptions: ["At least he\'s honest. I\'ll climb in.", "Wait, I know how to change a tire."]))
        ...
        pageList.append(StoryPages(text: "What? Such a cop out! Did you know accidental traffic accidents are the second leading cause ofaccidental death for most adult age groups?", answerOptions: []))
        pageList.append(StoryPages(text: "As you smash through the guardrail and careen towards the jagged rocks below you reflect on the dubious wisdom of stabbing someone while they are driving a car you are in.", answerOptions: []))
        pageList.append(StoryPages(text: "You bond with the murderer while crooning verses of \"Can you feel the love tonight\". He drops you off at the next town. Before you go he asks you if you know any good places to dump bodies. You reply: \"Try the pier.\"", answerOptions: []))
    }
}
